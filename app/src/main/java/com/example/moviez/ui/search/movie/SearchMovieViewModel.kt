...
import com.example.moviez.paging.movie.SearchMovieDataSource
...
class SearchMovieViewModel : ViewModel() {
    ...
    private fun getDataSource(query: String) = SearchMovieDataSource(
        searchService,
        query
    )
    ...
    fun getMoviePagingFlow(query: String) =
