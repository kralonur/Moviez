...
import com.example.moviez.model.credits.Credits
import com.example.moviez.model.genre.Genre
import com.example.moviez.model.image.Images
import com.example.moviez.model.production.ProductionCompany
import com.example.moviez.model.video.VideoResponse
...
data class TVDetails(
    ...
    @Json(name = "last_episode_to_air") val episodeToAir: EpisodeToAir?,
    @Json(name = "name") val name: String,
    @Json(name = "networks") val networks: List<Network>,
    @Json(name = "next_episode_to_air") val nextEpisodeToAir: EpisodeToAir?,
